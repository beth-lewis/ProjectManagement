    ...
    <div id="container">
        ...
        <div id="content">
            ...
            <div id="main">
                    ...
                    <br />
                        <asp:ListBox ID="lstManufacturers" runat="server" style="margin-left: 0px" Width="266px" DataSourceID="SqlDataSource1" DataTextField="ManufacturerName" DataValueField="ManufacturerName" Height="118px"></asp:ListBox>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:PrototypeConnectionString2 %>" SelectCommand="SELECT [ManufacturerName] FROM [tblManufacturer] ORDER BY [ManufacturerName]"></asp:SqlDataSource>
                        <br />
...
&nbsp;<br /><br/>
                    ...
                    <br /> <br />
                                ...
                                <asp:Button ID="btnAdd" runat="server" style="z-index: 1;" Text="Add Manufacturer" height="26px" width="120px" OnClick="btnAdd_Click" />
                                

                                  <asp:Button ID="btnEdit" runat="server" style="z-index: 1;" Text="Edit Manufacturer" height="26px" width="120px" OnClick="btnEdit_Click" />
