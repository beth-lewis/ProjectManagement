        ...
        <div id="content">
            ...
            <div id="main">
                ...
                <br />
                        ...
                        <br /><br />
                <asp:Label ID="lblStartDate" runat="server" CssClass="auto-style30" Text="Start Date" Font-Bold="True"></asp:Label>

                        <br />                
                        <asp:TextBox ID="txtStartDate" runat="server" CssClass="auto-style28" Height="16px" Width="155px"></asp:TextBox>
                        <br />
                        <br />
